...
import com.example.mystorecake.adapter.BanhCuoiAdapter;
...
public class BanhCuoiActivity extends AppCompatActivity {
    Toolbar toolbarBanhCuoi;
    ListView lvBanhCuoi;
    BanhCuoiAdapter banhCuoiAdapter;
    ArrayList<SanPhamModel> BanhCuoiarraylist;
    int idbc;
    int page = 1;;
    View footerview;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_banh_cuoi);
    ...
    private void AnhXa() {
        toolbarBanhCuoi = (Toolbar) findViewById(R.id.toolbarbanhcuoi);
        lvBanhCuoi = (ListView) findViewById(R.id.listviewbanhcuoi);
        BanhCuoiarraylist = new ArrayList<>();
        banhCuoiAdapter = new BanhCuoiAdapter(getApplicationContext(), BanhCuoiarraylist);
        lvBanhCuoi.setAdapter(banhCuoiAdapter);
    ...
    private void GetIdloaisp() {
        idbc = getIntent().getIntExtra("idloaisanpham", -1);
        Log.d("giatriloaisp", idbc + "");
    }
    @Override
    ...
    private void ActionToolbar() {
        setSupportActionBar(toolbarBanhCuoi);
        // tạo nút home
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        // xét chức năng cho nút home
        toolbarBanhCuoi.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST,
            ...
            public void onResponse(String response) {
                ...
                if (response != null && response.length() != 2) {
                    // xoa thanh progess
                    lvBanhCuoi.removeFooterView(footerview);
                    try {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            BanhCuoiarraylist.add(new SanPhamModel(id, tenbanhkem, giabanhkem, hinhbanhkem, motabanhkem, Idlsp));
                            // cập nhập adapter
                            banhCuoiAdapter.notifyDataSetChanged();
                        }
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                param.put("idloaisanpham", String.valueOf(idbc));
                return param;
            }
        };
    ...
    public class mHandler extends Handler
    {
        ...
        public void handleMessage(Message msg) {
            ...
            {
                case 0:
                    lvBanhCuoi.addFooterView(footerview);
                    break;
                case 1:
                    GetData(++page);
                    isloading = false;
    ...
    private void LoadMoreData() {
        // click item
        lvBanhCuoi.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                // chuyen du lieu sang man hinh chitietsan pham
                Intent intent = new Intent(getApplicationContext(),ChiTietSanPhamActivity.class);
                intent.putExtra("thongtinsanpham",BanhCuoiarraylist.get(position));
                startActivity(intent);
            }
        });
        // bắt sự kiện kéo của list view
        lvBanhCuoi.setOnScrollListener(new AbsListView.OnScrollListener() {
            //  hỗ trợ vị trí đứng
            @Override
