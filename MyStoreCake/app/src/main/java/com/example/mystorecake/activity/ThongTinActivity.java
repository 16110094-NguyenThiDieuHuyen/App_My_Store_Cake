...
public class ThongTinActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng tiembanhDookki = new LatLng(10.753006, 106.671717);
        mMap.addMarker(new MarkerOptions().position(tiembanhDookki)
                .title("Tiệm Bánh Dookki")
                .snippet("21 Trần Hưng Đạo phường 6 Quận 5 Tp Hồ Chí Minh")
        .icon(BitmapDescriptorFactory.defaultMarker()));
       mMap.setMapType(GoogleMap.MAP_TYPE_NORMAL);
        CameraPosition cameraPosition = new CameraPosition.Builder()
                .target(tiembanhDookki).zoom(90).build();
