...
import com.example.mystorecake.adapter.BanhNgotAdapter;
...
public class BanhNgotActivity extends AppCompatActivity {
    Toolbar toolbarbanhngot;
    ListView lvbanhngot;
    BanhNgotAdapter banhngotAdapter;
    ArrayList<SanPhamModel> banhngotarraylist;
    int idbn;
    int page = 1;
    ...
    private void AnhXa() {
        toolbarbanhngot = (Toolbar) findViewById(R.id.toolbarbanhngot);
        lvbanhngot = (ListView) findViewById(R.id.listviewbanhngot);
        banhngotarraylist = new ArrayList<>();
        banhngotAdapter = new BanhNgotAdapter(getApplicationContext(), banhngotarraylist);
        lvbanhngot.setAdapter(banhngotAdapter);
    ...
    private void GetIdloaisp() {
        ...
        Log.d("giatriloaisp", idbn + "");
    }

    private void ActionToolbar() {
        setSupportActionBar(toolbarbanhngot);
        // tạo nút home
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        // xét chức năng cho nút home
        toolbarbanhngot.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST,
            ...
            public void onResponse(String response) {
                ...
                if (response != null && response.length() != 2) {
                    ...
                    // xoa thanh progess
                    lvbanhngot.removeFooterView(footerview);
                    try {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            banhngotarraylist.add(new SanPhamModel(id, tenbanhkem, giabanhkem, hinhbanhkem, motabanhkem, Idlsp));
                            // cập nhập adapter
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                param.put("idloaisanpham", String.valueOf(idbn));
                return param;
            }
        };
...
public class mHandler extends Handler
{
    ...
    public void handleMessage(Message msg) {
        ...
        {
            case 0:
                lvbanhngot.addFooterView(footerview);
                break;
            case 1:
                GetData(++page);
                isloading = false;
...
public class ThreadData extends Thread{
    ...
    private void LoadMoreData() {
        // click item
        lvbanhngot.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                // chuyen du lieu sang man hinh chitietsan pham
                Intent intent = new Intent(getApplicationContext(),ChiTietSanPhamActivity.class);
                intent.putExtra("thongtinsanpham",banhngotarraylist.get(position));
                startActivity(intent);
            }
        });
        // bắt sự kiện kéo của list view
        lvbanhngot.setOnScrollListener(new AbsListView.OnScrollListener() {
            //  hỗ trợ vị trí đứng
            @Override
            ...
            public void onScroll(AbsListView view, int firstItem, int visibleItem, int totalItem) {
                ...
                {
                    isloading = true;
                    BanhNgotActivity.ThreadData threadData = new BanhNgotActivity.ThreadData();
                    threadData.start();
